...
function getTheme(): Theme {
  const heureActuelle: number = new Date().getHours();
...
function appliquerTheme(theme: Theme): void {
  ...
  console.log(
    `[meteo.ts] Thème appliqué : ${theme.toUpperCase()} — Heure : ${new Date().getHours()}h`
  );
}
...
/* ============================================================
   ...
   ============================================================ */
function mettreAJourTheme(): void {
